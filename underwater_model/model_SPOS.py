...
class Water(nn.Module):
    ...
    def forward(self, rgb, hsv, lab, trans_map, select):
        ...
        first_rgb, first_hsv, first_lab, second_rgb, second_hsv, second_lab, third_rgb, third_hsv, third_lab = self.base(rgb, hsv, lab)
        ...
        final = self.search(third, second, first, select[3:])
