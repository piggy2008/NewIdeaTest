...
def train(net, discriminator, optimizer, optimizer_d):
    ...
    while True:
        ...
        for i, data in enumerate(train_loader):
            ...
            train_single2(net, None, rgb, lab, None, None, None, optimizer, None, curr_iter)
            curr_iter += 1
...
def train_single2(net, discriminator, rgb, lab, target, lab_target, depth, optimizer, optimizer_d, curr_iter):
    ...
    loss0 = criterion(final, lab[:, 1:, :, :])
    loss1 = criterion_l1(final, lab[:, 1:, :, :])
    ...
    print_log(total_loss, loss0, loss0, loss1, args['train_batch_size'], curr_iter, optimizer)
